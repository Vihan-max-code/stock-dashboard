...
const STOCKS = [
  { ticker:"AAPL", name:"Apple", sector:"Technology", industry:"Consumer Hardware", marketCap:4631, color:"#2DD4BF", divYield:0.9,
  ...
  { ticker:"MSFT", name:"Microsoft", sector:"Technology", industry:"Software", marketCap:2861, color:"#5EEAD4", divYield:1.4,
  ...
  { ticker:"NVDA", name:"NVIDIA", sector:"Technology", industry:"Semiconductors", marketCap:5105, color:"#14B8A6", divYield:0.2,
  ...
  { ticker:"GOOGL", name:"Alphabet", sector:"Technology", industry:"Internet Services", marketCap:4328, color:"#7DD3FC", divYield:0.0,
  ...
  { ticker:"AMZN", name:"Amazon", sector:"Retail", industry:"Internet Commerce", marketCap:2639, color:"#FB923C", divYield:0.0,
  ...
  { ticker:"META", name:"Meta Platforms", sector:"Technology", industry:"Internet Software", marketCap:1693, color:"#A78BFA", divYield:0.2,
  ...
  { ticker:"JPM", name:"JPMorgan Chase", sector:"Finance", industry:"Investment Banking", marketCap:886, color:"#D4A857", divYield:2.6,
  ...
  { ticker:"UNH", name:"UnitedHealth Group", sector:"Healthcare", industry:"Managed Care", marketCap:386, color:"#F472B6", divYield:1.2,
  ...
  { ticker:"XOM", name:"ExxonMobil", sector:"Energy", industry:"Oil & Gas Integrated", marketCap:568, color:"#E4693C", divYield:4.2,
  ...
  { ticker:"TSLA", name:"Tesla", sector:"Automotive", industry:"EV Manufacturing", marketCap:1527, color:"#EF4444", divYield:0.0,
  ...
  { ticker:"KO", name:"Coca-Cola", sector:"Consumer Staples", industry:"Beverages", marketCap:356, color:"#FDE68A", divYield:3.1,
  ...
  { ticker:"WMT", name:"Walmart", sector:"Retail", industry:"Supermarket Chains", marketCap:893, color:"#94A3B8", divYield:1.8,
  ...
  { ticker:"V", name:"Visa", sector:"Finance", industry:"Payments", marketCap:626, color:"#22D3EE", divYield:0.7,
  ...
  { ticker:"BAC", name:"Bank of America", sector:"Finance", industry:"Banking", marketCap:423, color:"#0EA5E9", divYield:2.1,
  ...
  { ticker:"LLY", name:"Eli Lilly", sector:"Healthcare", industry:"Pharmaceuticals", marketCap:1119, color:"#C084FC", divYield:1.1,
  ...
  { ticker:"PFE", name:"Pfizer", sector:"Healthcare", industry:"Pharmaceuticals", marketCap:138, color:"#E879F9", divYield:4.3,
  ...
  { ticker:"PG", name:"Procter & Gamble", sector:"Consumer Staples", industry:"Household Products", marketCap:342, color:"#FDBA74", divYield:2.6,
  ...
  { ticker:"HD", name:"Home Depot", sector:"Consumer Discretionary", industry:"Home Improvement Retail", marketCap:342, color:"#FB7185", divYield:2.3,
  ...
  { ticker:"MCD", name:"McDonald's", sector:"Consumer Discretionary", industry:"Restaurants", marketCap:195, color:"#FBBF24", divYield:2.2,
  ...
  { ticker:"DIS", name:"Disney", sector:"Communication Services", industry:"Media & Entertainment", marketCap:167, color:"#818CF8", divYield:0.7,
  ...
  { ticker:"CAT", name:"Caterpillar", sector:"Industrials", industry:"Construction & Mining Equipment", marketCap:429, color:"#EAB308", divYield:2.1,
  ...
  { ticker:"NEE", name:"NextEra Energy", sector:"Utilities", industry:"Electric Power", marketCap:183, color:"#4ADE80", divYield:2.7,
  ...
  { ticker:"LIN", name:"Linde", sector:"Materials", industry:"Industrial Gases", marketCap:245, color:"#67E8F9", divYield:1.4,
  ...
  { ticker:"AMT", name:"American Tower", sector:"Real Estate", industry:"Cell Tower REIT", marketCap:84, color:"#C4B5FD", divYield:3.1,
  ...
  { ticker:"AVGO", name:"Broadcom", sector:"Technology", industry:"Semiconductors", marketCap:1903, color:"#F97316", divYield:1.8,
  ...
  { ticker:"NFLX", name:"Netflix", sector:"Communication Services", industry:"Streaming", marketCap:310, color:"#E11D48", divYield:0.0,
  ...
  { ticker:"AMD", name:"AMD", sector:"Technology", industry:"Semiconductors", marketCap:863, color:"#34D399", divYield:0.0,
  ...
  { ticker:"COST", name:"Costco", sector:"Retail", industry:"Warehouse Clubs", marketCap:420, color:"#D946EF", divYield:0.7,
  ...
  { ticker:"CRM", name:"Salesforce", sector:"Technology", industry:"Cloud Software", marketCap:134, color:"#60A5FA", divYield:0.0,
  ...
  { ticker:"BRK.B", name:"Berkshire Hathaway", sector:"Finance", industry:"Conglomerate", marketCap:1100, color:"#A3E635", divYield:0.0,
  ...
  { ticker:"SPY", name:"S&P 500 ETF", sector:"Index Fund", industry:"Broad Market ETF", marketCap:660, color:"#CBD5E1", divYield:1.4,
...
const ENRICHED = STOCKS.map(s => {
  ...
  const cagr10 = cagr(s.prices,2015,2025);
  // Approximate total return: compounds the price CAGR with the average
  // dividend yield each year, assuming dividends were reinvested at that
  // flat average rate. This is an estimate, not a real reinvestment
  // calculation using actual per-year dividend payments and prices.
  const totalReturnCagr = ((1 + cagr10/100) * (1 + s.divYield/100) - 1) * 100;
  return { ...s, cagr10, vol: stdev(returns), returns, totalReturnCagr };
});
...
/* ---------------------------------------------------------------------
   WATCHLIST — stored in localStorage, shared across all pages.
--------------------------------------------------------------------- */
const WATCHLIST_KEY = "sd_watchlist";
...
function isWatchlisted(ticker) {
  return getWatchlist().has(ticker);
}
 
function toggleWatchlist(ticker) {
  const set = getWatchlist();
  set.has(ticker) ? set.delete(ticker) : set.add(ticker);
  try {
...
/* ---------------------------------------------------------------------
   THEME — dark (default) / light, stored in localStorage, shared
   across all pages. The class itself is applied earlier, synchronously
   in <head>, to avoid a flash of the wrong theme before this file loads;
   this just wires up the toggle button if the page has one.
--------------------------------------------------------------------- */
